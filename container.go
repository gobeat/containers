...
func (c *factoryContainer) Bind(abstract interface{}, concrete interface{}) error {
	...
	return errors.New(bindInvalidArgumentsError)
}
...
func (c *factoryContainer) Resolve(abstract interface{}, args ...interface{}) (concrete interface{}, err error) {
	...
	return nil, errors.New(resolveInvalidArgumentError)
}
...
func (c *factoryContainer) Inject(target interface{}) error {
	...
	case reflect.Ptr:
	default:
		return errors.New(fmt.Sprintf(injectInvalidTargetTypeError, t.Kind()))
	}
...
func (c *factoryContainer) bindInterface(at reflect.Type, concrete interface{}) error {
	...
	case reflect.Ptr:
		if c.instanceOf(at, ct) == false {
			return errors.New(fmt.Sprintf(bindInvalidInstanceError, ct, at))
		}
	default:
		return errors.New(fmt.Sprintf(bindInvalidConcreteError, ct.Kind()))
	}
...
func (c *factoryContainer) bindStruct(at reflect.Type, concrete interface{}) error {
	...
	if at.String() != ct.String() {
		return errors.New(fmt.Sprintf(bindInvalidStructConcreteError, at.String(), ct.String()))
	}
...
func (c *factoryContainer) resolveInterface(at reflect.Type, args ...interface{}) (interface{}, error) {
	...
	if ok == false {
		return nil, errors.New(fmt.Sprintf(resolveNotExistAbstractError, at))
	}
	...
	default:
		return nil, errors.New(fmt.Sprintf(resolveInvalidConcreteError, value.Kind()))
	}
}
...
func (c *factoryContainer) structOf(value interface{}) (reflect.Type, error) {
	...
	if t.Kind() != reflect.Struct {
		return nil, errors.New(bindInvalidStructError)
	}
...
func (c *factoryContainer) structOfType(t reflect.Type) (reflect.Type, error) {
	...
	case reflect.Ptr:
		return t.Elem(), nil
	default:
		return nil, errors.New(bindInvalidStructTypeError)
	}
}
...
func (c *factoryContainer) interfaceOf(value interface{}) (reflect.Type, error) {
	...
	if t.Kind() != reflect.Interface {
		return nil, errors.New(bindInvalidInterfaceError)
	}
...
func (c *factoryContainer) resolveFunc(value reflect.Value, args ...interface{}) (interface{}, error) {
	t := value.Type()
	if len(args) != t.NumIn() {
		return nil, errors.New(fmt.Sprintf(resolveInsufficientArgumentsError, t.NumIn(), len(args)))
	}
	...
	out := value.Call(in)
	if len(out) == 0 {
		return nil, errors.New(resolveNonValuesReturnedError)
	}
